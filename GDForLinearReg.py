...
def LoadDataSet(filename, delim = ','):
    ...
    for x in rawdata.split('\n'):
        ...
        observation = np.array(x.split(delim))
...
def GradientDescent(X, y, alpha, iterations, epsilon = 1, costtracking = False):
...
def ComputeCostGrid(xstart, xend, ystart, yend):
    """ 
    Returns:
...
#gridx, gridy, gridz = ComputeCostGrid(-10, 10, -1, 4)
